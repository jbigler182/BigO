...
function logUpTo(n) {
  ...
  //O(n) Linear time. The time will grow equal to the size of the input
  ...
  function logAtLeast10(n) {
    ...
    //O(1) constant time. n has a max input of 10. So this function, although a loop, is limited, making it effiecent
    ...
    //O(n) linear time. The time will increase evenly with the size of the input of the array
    ...
    //O(n^2) Loop inside a loop. Not efficient 
